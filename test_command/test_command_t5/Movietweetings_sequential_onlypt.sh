...
#SBATCH --output=Movietweetings_sequential_pt.out          # Name of the output file
#SBATCH --error=Movietweetings_sequential_pt.err           # Name of the error file
...
python ../../src/src_t5/main.py --datasets Movietweetings --distributed 1 --gpu 2,3 --tasks sequential,straightforward --item_indexing sequential --epochs 10 --batch_size 128 --master_port 1984 --prompt_file ../../prompt.txt --sample_prompt 1 --eval_batch_size 1 --dist_sampler 0 --max_his 20  --sample_num 3,3 --train 0 --test_prompt unseen:0 --lr 1e-3 --test_before_train 0 --test_epoch 0 --test_filtered 1 --test_filtered_batch 0 --model_name Movietweetings_sequential.pt