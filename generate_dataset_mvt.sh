#!/bin/bash
#SBATCH --job-name=generate_dataset_mvt       # Name of the job
#SBATCH --nodes=1                   # Number of nodes
#SBATCH --partition=a10g-4-gm96-c48-m192        # partition name
#SBATCH --gpus=2                       # Enter no.of gpus needed
#SBATCH --output=generate_dataset_mvt.out          # Name of the output file
#SBATCH --error=generate_dataset_mvt.err           # Name of the error file
